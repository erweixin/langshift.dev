...
func (locker PostgresLocker) withLock(ctx context.Context, identity string, operation func(context.Context) error) (bool, error) {
	...
	key := "tool-effect-sweeper:v1:" + identity
	var locked bool
	...
	if unlockErr != nil || !unlocked {
		...
		closeCancel()
		return true, errors.Join(operationErr, unlockErr, closeErr, errors.New("tool effect sweeper advisory lock release failed"))
	}
