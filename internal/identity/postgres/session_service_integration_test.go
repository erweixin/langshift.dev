...
func TestSessionLifecycleIsPaginatedOwnedCASIdempotentAndEvented(t *testing.T) {
	...
	service := AuthService{
		...
		PublicTenantID: publicTenantID, StoreEpoch: "40000000-0000-0000-0000-000000000701", Region: "US", VerificationTTL: 24 * time.Hour, PasswordResetTTL: 30 * time.Minute, EmailChangeTTL: 24 * time.Hour, SessionTTL: 30 * 24 * time.Hour, IdempotencyTTL: 24 * time.Hour,
