...
func TestPasswordRecoveryAndChangeAreUniformSingleUseRotatingAndSecretSafe(t *testing.T) {
	...
	service := AuthService{
		...
		PublicTenantID: publicTenantID, StoreEpoch: "40000000-0000-0000-0000-000000000801", Region: "US", VerificationTTL: 24 * time.Hour, PasswordResetTTL: 30 * time.Minute, SessionTTL: 30 * 24 * time.Hour, IdempotencyTTL: 24 * time.Hour,
