...
BEGIN
  ...
  IF actual <> 89 THEN RAISE EXCEPTION 'expected 89 contract tables, found %', actual; END IF;
  ...
  IF actual <> 82 THEN RAISE EXCEPTION 'expected 82 forced-RLS tables, found %', actual; END IF;
