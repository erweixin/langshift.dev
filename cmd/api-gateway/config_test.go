...
func TestGatewayConfigAllowsExplicitLoopbackDevelopment(t *testing.T) {
	...
	t.Setenv("BEHAVIOR_UPSTREAM_URL", "http://127.0.0.1:8446")
	t.Setenv("BEHAVIOR_UPSTREAM_ROOT_CA_FILE", "")
	...
	t.Setenv("PRODUCT_UPSTREAM_URL", "http://127.0.0.1:8448")
	t.Setenv("PRODUCT_UPSTREAM_ROOT_CA_FILE", "")
