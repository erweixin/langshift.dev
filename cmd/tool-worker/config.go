...
func loadConfig() (config, error) {
	...
	value := config{
		...
		artifactPath: os.Getenv("TOOL_REGISTRY_ARTIFACT_FILE"), artifactHash: os.Getenv("TOOL_REGISTRY_ARTIFACT_HASH"), workerID: env("TOOL_WORKER_ID", os.Getenv("HOSTNAME")), healthAddress: env("HEALTH_ADDRESS", "127.0.0.1:8090"),
