...
func main() {
	fmt.Println(singleNumber([]int{2, 2, 1}), singleNumber([]int{4, 1, 2, 1, 2}), singleNumber([]int{1}), singleNumber([]int{0, 0, 7}), singleNumber([]int{-1, -1, -2}))
}
```
</UniversalEditor>
...
func main() {
	fmt.Println(majorityElement([]int{3, 2, 3}), majorityElement([]int{2, 2, 1, 1, 1, 2, 2}), majorityElement([]int{1}), majorityElement([]int{1, 1, 2}), majorityElement([]int{6, 5, 5}))
}
```
</UniversalEditor>
...
func main() {
	...
	fmt.Println(sortColors([]int{1, 1, 1, 0, 2, 0}))
	fmt.Println(sortColors([]int{2, 2, 2, 1, 0}))
}
```
</UniversalEditor>
