...
fn main() {
    ...
    println!("{}", unique_paths(1, 1));   // 1
    println!("{}", unique_paths(1, 10));  // 1
    println!("{}", unique_paths(10, 1));  // 1
}
```
...
fn main() {
    ...
    println!("{}", min_path_sum(vec![vec![5]]));                               // 5
    println!("{}", min_path_sum(vec![vec![1], vec![2], vec![3]]));             // 6
    println!("{}", min_path_sum(vec![vec![1,1,1], vec![1,1,1]]));             // 4
}
```
...
fn main() {
    println!("{}", longest_palindrome("babad".into()).len() == 3); // true
    println!("{}", longest_palindrome("cbbd".into()));            // bb
    println!("{}", longest_palindrome("a".into()));                // a
    println!("{}", longest_palindrome("ac".into()));               // a or c
    println!("{}", longest_palindrome("racecar".into()));          // racecar
}
```
...
fn main() {
    println!("{}", longest_common_subsequence("abcde".into(), "ace".into())); // 3
    println!("{}", longest_common_subsequence("abc".into(), "abc".into()));   // 3
    println!("{}", longest_common_subsequence("abc".into(), "def".into()));   // 0
    println!("{}", longest_common_subsequence("".into(), "a".into()));       // 0
    println!("{}", longest_common_subsequence("bsbininm".into(), "jmjkbkjkv".into())); // 1
}
```
...
fn main() {
    println!("{}", min_distance("horse".into(), "ros".into()));                 // 3
    println!("{}", min_distance("intention".into(), "execution".into()));       // 5
    println!("{}", min_distance("".into(), "a".into()));                       // 1
    println!("{}", min_distance("a".into(), "".into()));                      // 1
    println!("{}", min_distance("abc".into(), "abc".into()));                   // 0
}
```
