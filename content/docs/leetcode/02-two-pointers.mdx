...
func main() {
	...
	fmt.Println(moveZeroes([]int{0, 0, 0, 1}))       // [1 0 0 0]
	fmt.Println(moveZeroes([]int{4, 0, 5, 0, 0, 6})) // [4 5 6 0 0 0]
}
```
</UniversalEditor>
...
func main() {
	...
	fmt.Println(maxArea([]int{2, 3, 10, 5, 7, 8, 9}))      // 36
}
```
</UniversalEditor>
...
fn main() {
    ...
    println!("{}", max_area(vec![4, 3, 2, 1, 4]));              // 16
    println!("{}", max_area(vec![1, 2, 1]));                     // 2
    println!("{}", max_area(vec![2, 3, 10, 5, 7, 8, 9]));       // 36
}
```
...
fn main() {
    ...
    println!("{:?}", three_sum(vec![-2, 0, 1, 1, 2]));       // [[-2,0,2],[-2,1,1]]
}
```
...
fn trap(height: Vec<i32>) -> i32 {
    let (mut l, mut r) = (0, height.len() - 1);
    let (mut left_max, mut right_max, mut ans) = (0, 0, 0);
    while l < r {
        if height[l] < height[r] {
...
fn main() {
    ...
    println!("{}", trap(vec![]));                                       // 0
    println!("{}", trap(vec![2, 0, 2]));                               // 2
    println!("{}", trap(vec![3, 0, 1, 3, 0, 5]));                     // 8
}
```
