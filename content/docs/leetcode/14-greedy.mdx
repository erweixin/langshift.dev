...
fn main() {
    ...
    println!("{}", max_profit(vec![1,2,3,4,5]));    // 4
    println!("{}", max_profit(vec![2,4,1]));         // 2
    println!("{}", max_profit(vec![3]));             // 0
}
```
...
fn main() {
    ...
    println!("{}", can_jump(vec![0]));          // true
    println!("{}", can_jump(vec![1,0,1,0]));   // false
...
fn main() {
    println!("{}", jump(vec![2,3,1,1,4])); // 2
    println!("{}", jump(vec![2,3,0,1,4])); // 2
    println!("{}", jump(vec![0]));          // 0
    println!("{}", jump(vec![1,2]));        // 1
    println!("{}", jump(vec![1,1,1,1]));   // 3
}
```
...
fn main() {
    println!("{:?}", partition_labels("ababcbacadefegdehijhklij".to_string())); // [9, 7, 8]
    println!("{:?}", partition_labels("eccbbbbdec".to_string()));               // [10]
    println!("{:?}", partition_labels("a".to_string()));                        // [1]
    println!("{:?}", partition_labels("ab".to_string()));                       // [1, 1]
    println!("{:?}", partition_labels("caedbdedda".to_string()));               // [1, 9]
}
```
