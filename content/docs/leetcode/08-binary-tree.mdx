...
func main() {
	fmt.Println(inorderTraversal(buildTree([]interface{}{1, nil, 2, 3})))
	fmt.Println(inorderTraversal(buildTree(nil)))
	fmt.Println(inorderTraversal(buildTree([]interface{}{1})))
}
```
</UniversalEditor>
...
func main() {
	fmt.Println(maxDepth(buildTree([]interface{}{3, 9, 20, nil, nil, 15, 7})))
	fmt.Println(maxDepth(buildTree([]interface{}{1, nil, 2})))
	fmt.Println(maxDepth(buildTree(nil)))
	fmt.Println(maxDepth(buildTree([]interface{}{1})))
}
```
</UniversalEditor>
...
func main() {
	fmt.Println(levelOrder(invertTree(buildTree([]interface{}{4, 2, 7, 1, 3, 6, 9}))))
	fmt.Println(levelOrder(invertTree(buildTree([]interface{}{2, 1, 3}))))
	fmt.Println(levelOrder(invertTree(buildTree(nil))))
}
```
</UniversalEditor>
...
func main() {
	fmt.Println(isSymmetric(buildTree([]interface{}{1, 2, 2, 3, 4, 4, 3})))
	fmt.Println(isSymmetric(buildTree([]interface{}{1, 2, 2, nil, 3, nil, 3})))
	fmt.Println(isSymmetric(buildTree(nil)))
	fmt.Println(isSymmetric(buildTree([]interface{}{1})))
}
```
</UniversalEditor>
...
func main() {
	fmt.Println(diameterOfBinaryTree(buildTree([]interface{}{1, 2, 3, 4, 5})))
	fmt.Println(diameterOfBinaryTree(buildTree([]interface{}{1, 2})))
	fmt.Println(diameterOfBinaryTree(buildTree([]interface{}{1})))
	fmt.Println(diameterOfBinaryTree(buildTree(nil)))
}
```
</UniversalEditor>
...
func main() {
	fmt.Println(levelOrder(buildTree([]interface{}{3, 9, 20, nil, nil, 15, 7})))
	fmt.Println(levelOrder(buildTree([]interface{}{1})))
	fmt.Println(levelOrder(buildTree(nil)))
}
```
</UniversalEditor>
...
func main() {
	fmt.Println(inorder(sortedArrayToBST([]int{-10, -3, 0, 5, 9})))
	fmt.Println(inorder(sortedArrayToBST([]int{1, 3})))
	fmt.Println(inorder(sortedArrayToBST(nil)))
	fmt.Println(inorder(sortedArrayToBST([]int{0})))
}
```
</UniversalEditor>
...
func main() {
	fmt.Println(isValidBST(buildTree([]interface{}{2, 1, 3})))
	fmt.Println(isValidBST(buildTree([]interface{}{5, 1, 4, nil, nil, 3, 6})))
	fmt.Println(isValidBST(buildTree([]interface{}{1, 1})))
	fmt.Println(isValidBST(buildTree(nil)))
}
```
</UniversalEditor>
...
func main() {
	...
	fmt.Println(kthSmallest(buildTree([]interface{}{3, 1, 4, nil, 2}), 2))
	fmt.Println(kthSmallest(buildTree([]interface{}{5, 3, 6, 2, 4, nil, nil, 1}), 3))
	fmt.Println(kthSmallest(buildTree([]interface{}{2, 1, 3}), 2))
	fmt.Println(kthSmallest(buildTree([]interface{}{1}), 1))
}
```
</UniversalEditor>
...
func main() {
	fmt.Println(rightSideView(buildTree([]interface{}{1, 2, 3, nil, 5, nil, 4})))
	fmt.Println(rightSideView(buildTree([]interface{}{1, nil, 3})))
	fmt.Println(rightSideView(buildTree(nil)))
	fmt.Println(rightSideView(buildTree([]interface{}{1, 2, 3, 4})))
}
```
</UniversalEditor>
...
func toRightList(root *TreeNode) []int {
	var res []int
...
func main() {
	fmt.Println(toRightList(flatten(buildTree([]interface{}{1, 2, 5, 3, 4, nil, 6}))))
	fmt.Println(toRightList(flatten(buildTree(nil))))
	fmt.Println(toRightList(flatten(buildTree([]interface{}{0}))))
	fmt.Println(toRightList(flatten(buildTree([]interface{}{1, nil, 2, 3}))))
	fmt.Println(toRightList(flatten(buildTree([]interface{}{1, 2}))))
}
```
</UniversalEditor>
...
func inorderTrav(root *TreeNode) []int {
	...
	var res []int
	res = append(res, inorderTrav(root.Left)...)
	res = append(res, root.Val)
	res = append(res, inorderTrav(root.Right)...)
	return res
}
...
func main() {
	pre := []int{3, 9, 20, 15, 7}
	ino := []int{9, 3, 15, 20, 7}
	t := buildTreeFromPreIn(pre, ino)
	fmt.Println(inorderTrav(t))
	pre2 := []int{1}
	ino2 := []int{1}
	t2 := buildTreeFromPreIn(pre2, ino2)
	fmt.Println(inorderTrav(t2))
}
```
</UniversalEditor>
...
func main() {
	fmt.Println(pathSum(buildTree([]interface{}{10, 5, -3, 3, 2, nil, 11, 3, -2, nil, 1}), 8))
	fmt.Println(pathSum(buildTree([]interface{}{5, 4, 8, 11, nil, 13, 4, 7, 2, nil, nil, 5, 1}), 22))
	fmt.Println(pathSum(buildTree([]interface{}{1}), 1))
	fmt.Println(pathSum(buildTree([]interface{}{1, nil, 2, nil, 3, nil, 4}), 3))
	fmt.Println(pathSum(buildTree(nil), 0))
}
```
</UniversalEditor>
...
func main() {
	t := buildTree([]interface{}{3, 5, 1, 6, 2, 0, 8, nil, nil, 7, 4})
	fmt.Println(lowestCommonAncestor(t, find(t, 5), find(t, 1)).Val)
	fmt.Println(lowestCommonAncestor(t, find(t, 5), find(t, 4)).Val)
	t2 := buildTree([]interface{}{1, 2})
	fmt.Println(lowestCommonAncestor(t2, find(t2, 1), find(t2, 2)).Val)
	t3 := buildTree([]interface{}{2, 1, 3})
	fmt.Println(lowestCommonAncestor(t3, find(t3, 1), find(t3, 3)).Val)
}
```
</UniversalEditor>
...
func main() {
	fmt.Println(maxPathSum(buildTree([]interface{}{-10, 9, 20, nil, nil, 15, 7})))
	fmt.Println(maxPathSum(buildTree([]interface{}{-3})))
	fmt.Println(maxPathSum(buildTree([]interface{}{2, -1})))
	fmt.Println(maxPathSum(buildTree([]interface{}{5, 4, 8, 11, nil, 13, 4, 7, 2, nil, nil, nil, 1})))
}
```
</UniversalEditor>
