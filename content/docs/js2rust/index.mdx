---
title: JavaScript to Rust
description: Welcome to LangShift.dev's **JavaScript to Rust Conversion Learning Module**!
---
...
[**Start Learning: Introduction to Rust & Environment Setup →**](./js2rust/module-00-rust-introduction)
