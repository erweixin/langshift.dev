---
title: "模組 07: 繼承和多型"
description: "学习 Java 繼承、多型、方法重寫和抽象類，与 JavaScript 原型繼承进行对比。"
---

# 模組 07: 繼承和多型

在本模組中，我们将探索 Java 的繼承和多型机制，并将其与 JavaScript 基于原型的繼承进行对比。Java 提供了具有方法重寫和多型的结构化類层次结构，而 JavaScript 使用原型链进行繼承。

## 学习目标

通过本模組的学习，你将能够：
- 理解 Java 繼承和類层次结构
- 对比 Java 繼承与 JavaScript 原型链
- 实现方法重寫和多型
- 使用抽象類和方法
- 应用繼承最佳实践
- 理解繼承和组合之间的差异
...
Java 使用 `extends` 关键字进行显式類繼承，而 JavaScript 使用原型链。

<UniversalEditor title="類繼承" compare={true}>
```javascript !! js
// JavaScript - 基于原型的繼承
// 基類（建構函數）
...
class InheritanceDemo {
    public static void main(String[] args) {
        ...
        for (Animal a : animals) {
            System.out.println(a.makeSound()); // 每种類型的不同行为
        }
...
Java 提供带有 `@Override` 注解的显式方法重寫，而 JavaScript 使用基于原型的方法替换。

<UniversalEditor title="方法重寫和多型" compare={true}>
```javascript !! js
// JavaScript - 方法重寫和多型
// 基類
class Shape {
...
Java 提供抽象類进行部分实现，而 JavaScript 没有直接等价物。

<UniversalEditor title="抽象類和方法" compare={true}>
```javascript !! js
// JavaScript - 模拟抽象類
// 具有抽象類方法的基類
...
<UniversalEditor title="练习 1: 繼承实现">
```java !! java
// TODO: 实现具有适当繼承的这些類
public abstract class Employee {
    // TODO: 添加受保護字段 name、id、salary
...
<UniversalEditor title="练习 2: 多型和方法重寫">
```java !! java
// TODO: 实现多型银行系统
public abstract class BankAccount {
    // TODO: 添加受保護字段 accountNumber、balance、owner
...
在本模組中，我们探索了 Java 的繼承和多型机制，并将其与 JavaScript 基于原型的繼承进行了对比：

### 关键要点：
1. **類繼承**: Java 使用 `extends` 关键字进行显式繼承
2. **方法重寫**: Java 提供 `@Override` 注解进行显式方法重寫
3. **多型**: Java 通过方法重寫支持运行时多型
4. **抽象類**: Java 提供抽象類进行部分实现
5. **存取控制**: Java 使用 `protected` 进行繼承特定存取
...
- [Java 繼承](https://docs.oracle.com/javase/tutorial/java/IandI/subclasses.html)
- [Java 多型](https://docs.oracle.com/javase/tutorial/java/IandI/polymorphism.html)
- [Java 抽象類](https://docs.oracle.com/javase/tutorial/java/IandI/abstract.html)

---

**练习提示**: 专注于理解繼承和组合之间的差异。练习实现具有抽象類的适当類层次结构。创建演示运行时行为变化的多型系统。 