---
title: "模块 06: 类和对象"
description: "学习 Java 类和对象、构造函数、访问修饰符和封装，与 JavaScript 面向对象编程进行对比。"
---
...
<UniversalEditor title="类声明和对象创建" compare={true}>
```javascript !! js
// JavaScript - 多种创建对象的方式
// 对象字面量
const person1 = {
    name: "Alice",
    age: 25,
...
class ClassBasicsDemo {
    public static void main(String[] args) {
        ...
        Person person3 = new Person(person2); // 复制构造函数
...
<UniversalEditor title="访问修饰符和封装" compare={true}>
```javascript !! js
// JavaScript - 封装模式
// 模块模式用于封装
...
public class BankAccount {
    ...
    public List<Transaction> getTransactions() {
        return new ArrayList<>(transactions); // 返回副本进行封装
    }
...
- [Java 访问修饰符](https://docs.oracle.com/javase/tutorial/java/javaOO/accesscontrol.html)
