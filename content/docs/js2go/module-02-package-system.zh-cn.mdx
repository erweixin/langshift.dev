...
<UniversalEditor title="包声明规则对比" compare={true} canRun={false}>
```javascript !! js
...
<UniversalEditor title="包名约定对比" compare={true} canRun={false}>
```javascript !! js
// JavaScript: 模块系统 (ES6)
// file: math.js
...
<UniversalEditor title="实际项目结构示例" compare={true} canRun={false}>
```javascript !! js
// JavaScript: 项目结构
my-project/
├── src/
...
<UniversalEditor title="依赖包格式对比" compare={true} canRun={false}>
```javascript !! js
// JavaScript: 包名格式
// package.json
{
...
<UniversalEditor title="包命名约定对比" compare={true} canRun={false}>
```javascript !! js
// JavaScript: 灵活的包命名
// 1. 简单包名
"express"
...
<UniversalEditor title="依赖解析机制对比" compare={true} canRun={false}>
```javascript !! js
...
<UniversalEditor title="模块初始化对比" compare={true} canRun={false}>
```javascript !! js
...
<UniversalEditor title="项目结构对比" compare={true} canRun={false}>
```javascript !! js
// JavaScript: 典型项目结构
my-project/
├── package.json
...
<UniversalEditor title="导入系统对比" compare={true} canRun={false}>
```javascript !! js
// JavaScript: 各种导入样式
// 默认导入
import express from 'express';
...
<UniversalEditor title="可见性规则对比" compare={true} canRun={false}>
```javascript !! js
// JavaScript: 显式导出
// file: utils.js
...
<UniversalEditor title="模块文件对比" compare={true} canRun={false}>
```javascript !! js
...
<UniversalEditor title="依赖管理命令" compare={true} canRun={false}>
```javascript !! js
...
<UniversalEditor title="模块路径格式详解" compare={true} canRun={false}>
```javascript !! js
// JavaScript: 包名与仓库分离
// package.json
{
...
<UniversalEditor title="模块路径的优势和挑战" compare={true} canRun={false}>
```javascript !! js
// JavaScript: 包名系统的特点
// 优势：
// 1. 包名简洁，易于记忆
...
<UniversalEditor title="Main 包示例" compare={true} canRun={false}>
```javascript !! js
// JavaScript: 入口点
// file: index.js
...
<UniversalEditor title="库包示例" compare={true} canRun={false}>
```javascript !! js
// JavaScript: 库模块
// file: math-utils.js
...
<UniversalEditor title="内部包示例" compare={true} canRun={false}>
```javascript !! js
// JavaScript: 无内置内部概念
// 约定：使用下划线前缀或放在私有目录中
...
<UniversalEditor title="Vendor 目录示例" compare={true} canRun={false}>
```javascript !! js
// JavaScript: 无内置供应商功能
...
<UniversalEditor title="工作区示例" compare={true} canRun={false}>
```javascript !! js
...
<UniversalEditor title="实际项目对比" compare={true} canRun={false}>
```javascript !! js
