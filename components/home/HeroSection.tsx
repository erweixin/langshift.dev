  ...
  return (
    <div className="relative overflow-hidden pt-16">
      ...
      <div className="absolute inset-0">
        <div className="absolute inset-0 bg-gradient-to-br from-amber-600/10 via-emerald-600/10 to-orange-600/10"></div>
        <div className="absolute top-0 left-0 w-full h-full">
          ...
          <div className="absolute bottom-20 left-1/3 w-80 h-80 bg-orange-500/20 rounded-full blur-3xl animate-pulse delay-2000"></div>
        </div>
      </div>
        ...
        <div className="text-center max-w-6xl mx-auto">
          ...
          <div className="mb-8">
            <h1 className="text-5xl md:text-7xl lg:text-8xl font-bold text-white mb-6 leading-tight">
              <span className="bg-gradient-to-r from-amber-400 via-emerald-500 to-orange-500 bg-clip-text text-transparent">
                {t.home.hero.title}
              </span>
            </h1>
          ...
          {/* 核心特性展示 */}
            ...
            <div className="bg-slate-800/30 backdrop-blur-sm border border-slate-700/50 rounded-2xl p-6 hover:scale-105 transition-all duration-300">
                <div className="w-12 h-12 bg-gradient-to-br from-orange-600 to-amber-500 rounded-xl flex items-center justify-center mb-4 mx-auto">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center mb-16">
            <Link
              href="#courses"
              className="group inline-flex items-center px-8 py-4 bg-gradient-to-r from-amber-500 to-orange-600 text-white font-semibold rounded-xl hover:from-amber-600 hover:to-orange-700 transition-all duration-300 transform hover:scale-105 shadow-lg hover:shadow-xl relative overflow-hidden"
            >
              {/* 免费标识动画 */}
