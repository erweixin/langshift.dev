...
const groups = [
  ...
  { kind: "policy", id: "guardrail-privacy-egress", prefixes: ["internal/security/guardrail/"], exact: ["internal/llmgateway/egress/policy.go", "internal/runtime/policy.go", "contracts/catalog/privacy-contract.json"], pilotScope: true },
