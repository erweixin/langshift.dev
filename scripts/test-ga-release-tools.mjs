...
const issueSnapshot = { schemaVersion: "1.0.0", provider: "github-graphql", repository: "erweixin/langshift.dev", sourceCommit: installerCommit, rcHash: installerRC.releaseCandidateHash, capturedAt: "2026-01-01T00:00:00.000Z", querySha256: "5".repeat(64), paginationComplete: true, pageCount: 1, totalCount: 0, issues: [] };
