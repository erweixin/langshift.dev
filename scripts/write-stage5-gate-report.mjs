...
check("MIGRATION-CURRENT", latest?.version === 83 && latest?.name === "task_pack_control_plane", "database evidence is bound to migration 83");
...
const target = resolve(root, "gate-reports/stage-5/stage5-automated-gate.json");
