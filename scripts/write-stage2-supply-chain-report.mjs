...
const services = ["api-gateway", "identity-service", "realtime-gateway", "identity-import-worker", "identity-mail-worker", "outbox-publisher", "store-epoch-authority", "lites-migrate"];
