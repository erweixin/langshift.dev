...
| [realtime.md](./realtime.md) | 9 | 实时通道、无竞态重连、慢消费者、权限变化、LLM token 流 |
| [runtime-and-sandbox.md](./runtime-and-sandbox.md) | 10 | runtime 威胁模型、隔离等级、secret broker（受控代发服务）、workspace 单写者 |
| [multi-tenancy-and-security.md](./multi-tenancy-and-security.md) | 11 | 租户隔离、权限模型、数据保留、删除与 Repair Command API |
| [operations.md](./operations.md) | 12 | Sweeper、可观测性、故障注入与不变量测试 |
| [capacity-and-scaling.md](./capacity-and-scaling.md) | 13 | 部署替换路径、负载向量、规模化就绪标准 |
| [roadmap.md](./roadmap.md) | 14 | 技术演进顺序 |
